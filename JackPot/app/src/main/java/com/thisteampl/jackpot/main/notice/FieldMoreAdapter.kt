...
class FieldMoreAdapter(val context: Context, val ProjectList: List<ProjectElementMaterial>?= null): BaseAdapter() {
    ...
    private var check2 = BooleanArray(30)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        var imagebackview = view.findViewById<ImageView>(R.id.holder_filter_project_image)
        ...
        // 배경색 변경
        if(randomindex==0){
            imagebackview.background = ContextCompat.getDrawable(context, R.drawable.attentionimagebluenview)
        }else if(randomindex ==1){
            imagebackview.background = ContextCompat.getDrawable(context, R.drawable.attentionimagegreenview)
        }else{
            imagebackview.background = ContextCompat.getDrawable(context, R.drawable.attentionimagepinkview)
        }
